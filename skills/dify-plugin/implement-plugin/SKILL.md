...
1. [architecture.md](./architecture.md) - runtime types, lifecycle, and hooks
2. [manifest.md](./manifest.md) - full manifest rules and validation
3. [credentials.md](./credentials.md) - credential schema and validation rules
4. [yaml-schemas.md](./yaml-schemas.md) - YAML patterns for credentials/params
5. [security.md](./security.md) - baseline security checklist
...
2. Draft `manifest.yaml` using [manifest.md](./manifest.md).
3. Define provider config YAML:
   - Use [credentials.md](./credentials.md) for credential rules
   - Use [yaml-schemas.md](./yaml-schemas.md) for YAML patterns
